...
enum {INACTIVITY, DISPLAY, MESSAGE, LED, ROTATION_TIMER, BUTTON_TIMER, TIMERS_CANT}; //Aca van los diferentes timers utilizados (inactividad, display, rotacion encoder, etc)
