...
enum {INACTIVITY, DISPLAY, MESSAGE, LED, ROTATION_TIMER, BUTTON_TIMER, DOOR, TIMERS_CANT}; //Aca van los diferentes timers utilizados (inactividad, display, rotacion encoder, etc)
